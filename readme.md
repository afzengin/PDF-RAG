...
The pipeline works great for text-heavy documents but isn’t the best fit for those with complex multi-modal content just yet. Don’t worry—we’re cooking up an update to tackle that with a multi-modal RAG pipeline powered by Vision LLMs. Actually, we did, access [MultiModel-RAG-ColPali-Qdrant-Qwen](https://github.com/afzengin/MultiModel-RAG-ColPali-Qdrant-Qwen) for all the materials. We’d love to hear your feedback or questions. Cheers!
